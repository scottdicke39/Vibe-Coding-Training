    ...
    keyFeatures: [
      {
        name: 'Lovable Cloud',
        description:
          'Lovable\'s built-in backend. When your app needs to save data, Lovable Cloud handles databases, authentication, file storage, and hosting automatically. No separate setup required.',
      },
      {
        name: 'Notion / Linear',
        description:
...
export const GLOSSARY: GlossaryTerm[] = [
  { term: 'MCP', definition: 'Model Context Protocol. A standard way for AI tools to connect to other services (Notion, Linear, databases).', analogy: 'USB ports for AI' },
  ...
  { term: 'Lovable Cloud', definition: 'Lovable\'s built-in backend. Handles databases, auth, file storage, and hosting automatically when you build in Lovable. Powered by Supabase under the hood.', analogy: 'The spreadsheet behind your app, but way more powerful, and you never have to set it up' },
...
export const RECIPES: RecipeContent[] = [
  {
    ...
    steps: [
      ...
      'When Lovable asks about backend needs, allow Lovable Cloud. It handles the database automatically.',
...
export const PROJECT_IDEAS: ProjectIdea[] = [
  ...
  { id: 6, title: 'Immigration Case Tracker', tools: 'Lovable', difficulty: 'Advanced', category: 'People Operations', description: 'A dashboard for tracking all active immigration cases: visa type, status, key dates, next steps, and assigned counsel.', prompt: 'Build an immigration case tracker dashboard. Each case shows: employee name, visa type, current status (filed, pending, approved), key dates, assigned counsel, and notes. Include filters by visa type and status, a timeline view, and color-coded urgency indicators.' },
  ...
  { id: 10, title: 'Team Health Scorecard', tools: 'Lovable', difficulty: 'Advanced', category: 'HRBPs', description: 'A dashboard for HRBP metrics: attrition rate, open headcount, time-to-fill, promotions, with green/yellow/red indicators per team.', prompt: 'Build a team health scorecard. Each team card shows: attrition rate, headcount (filled vs. open), time-to-fill average, and last promotion date. Green/yellow/red indicators based on thresholds. Filter by business unit.' },
  ...
  { id: 13, title: 'Pave Data Explorer', tools: 'Lovable', difficulty: 'Intermediate', category: 'Compensation', description: 'Interactive comp data visualization. Upload sample data and build charts comparing bands across levels and job families.', prompt: 'Build a compensation data explorer. I will upload a CSV with columns: job_family, level, location, base_min, base_mid, base_max, equity_min, equity_mid, equity_max. Show an interactive chart comparing base ranges across levels. Color-code by job family.' },
  { id: 14, title: 'Comp Equity Audit Dashboard', tools: 'Lovable', difficulty: 'Advanced', category: 'Compensation', description: 'Overlays anonymized comp data against band targets to visualize pay equity by level and demographic dimensions.', prompt: 'Build a pay equity dashboard. I will upload a CSV with: role, level, tenure, gender, ethnicity, base_salary, total_comp. Show box plots by demographic group within each level. Highlight gaps greater than 5%.' },
  ...
  { id: 28, title: 'Recruiter SLA Tracker', tools: 'Lovable', difficulty: 'Intermediate', category: 'Recruiting Operations', description: 'Dashboard for tracking response times, time-to-schedule, and time-to-feedback against SLA targets.', prompt: 'Build an SLA tracking dashboard. I will upload a CSV with: recruiter_name, candidate, action_type, target_hours, actual_hours, date. Show compliance rates and trend charts. Highlight anything over target in red.' },
  { id: 29, title: 'Stakeholder Training Hub', tools: 'Lovable', difficulty: 'Intermediate', category: 'Training and Enablement', description: 'A mini learning platform with Loom videos, guides, and completion tracking for hiring managers and interviewers.', prompt: 'Build a training hub app. List of modules, each with a title, description, embedded Loom video, and a Mark Complete checkbox. Users see progress across all modules. Sections: Interview Training, ATS Basics, Feedback, Assessments.' },
  { id: 30, title: 'New Recruiter Onboarding App', tools: 'Lovable', difficulty: 'Intermediate', category: 'Training and Enablement', description: 'Loom walkthroughs of each tool organized by first week, first month, first quarter with completion tracking.', prompt: 'Build a recruiter onboarding app. New recruiters see a curriculum organized by Week 1, Month 1, and Quarter 1. Each module has a Loom video, summary, key takeaways, and completion checkbox. Include a progress tracker.' },
...
export const HACK_DAY_INFO = {
  ...
  accessNotes: {
    ...
    lovable: 'Lovable Enterprise is being provisioned. Your Team Captain will confirm seat allocation. Lovable Cloud (built-in database, auth, and hosting) is enabled by default.',
    glean: 'Available to everyone through your existing Glean login. Navigate to Agent Builder from the sidebar.',
  },
  dataWarning: 'P&T works with sensitive information. On hack day, use sample or made-up data only. Do not put real employee info, comp data, or candidate PII into any tool. Lovable Cloud includes authentication, but be mindful of who can access what you build until proper access controls are configured.',
};
